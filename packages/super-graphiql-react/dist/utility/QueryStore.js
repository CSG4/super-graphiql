  ...
  _createClass(QueryStore, [{
    ...
    value: function contains(item) {
      return this.items.some(function (x) {
        return x.query === item.query ? Boolean(x.variables) && Boolean(item.variables) ? x.variables === item.variables : true : false;
      });
    }
  }, {
    key: "delete",
    value: function _delete(item) {
      var index = this.items.findIndex(function (x) {
        return x.query === item.query && x.variables === item.variables;
      }
    ...
    key: "concat",
    value: function concat(newItems) {
